...
public class _05_Stream {
    public static void main(String[] args) {
        ...
        // 90 점 이상인 점수만 출력
        Arrays.stream(scores).filter(x -> x>=90).forEach(x -> System.out.print(x+" "));
...
//        "python", "java", "javascript", "c", "c++", "c#"
        ...
        // java 라는 글자를 포함하는 언어
        Arrays.stream(langs).filter(x-> x.contains("java")).forEach(x-> System.out.println(x));
        System.out.println("============");
        ...
        // 4글자 이하의 언어를 가지는 언어
        langListStream.filter(x -> x.length() <= 4).sorted().forEach(System.out::println);
        System.out.println("==============");
